...
export default function LegalPage() {
  ...
  const handleAccept = () => {
    ...
    navigate('/apply?legal=accepted');
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8fffc] via-white to-emerald-50/50 px-4 py-8 sm:px-6 lg:px-8 text-gray-900 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute left-10 top-12 h-24 w-24 rounded-full bg-emerald-200/50 blur-3xl" />
        <div className="absolute right-16 top-20 h-28 w-28 rounded-full bg-teal-100/70 blur-3xl" />
        <div className="absolute left-20 bottom-16 h-32 w-32 rounded-full bg-emerald-100/70 blur-3xl" />
      </div>
        ...
        <div className="rounded-[32px] border border-slate-100 bg-white/95 shadow-[0_18px_60px_rgba(15,23,42,0.08)] overflow-hidden">
          <div className="px-6 md:px-10 py-8 md:py-10 bg-gradient-to-r from-[#1C5438] via-[#267347] to-[#2b7a56] text-white">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[16px] md:text-[18px] font-bold tracking-tight uppercase text-white">
                Ubuzima Connect
              </span>
            </div>
            ...
            <p className="mt-4 text-base text-white/80 max-w-4xl leading-8">
              Before your institution submits its application, Ubuzima Connect requires confirmation that you
              understand the clinical disclaimer, privacy commitments, role-based access controls, and anonymized
              retraining terms that govern use of the platform.
            </p>
          </div>
