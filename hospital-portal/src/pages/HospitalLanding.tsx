              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-2xl p-4">
                  ...
                  <p className="text-[10px] text-gray-400 leading-relaxed mb-3">
                    By submitting, you acknowledge that Ubuzima Connect will process your organisation's information — including hospital name, contact details, and uploaded logo — to evaluate your partnership application and configure system access if approved. Data is stored securely and not shared with third parties except as required by Rwandan law.
                  </p>
                  <label className="flex items-start gap-2 cursor-pointer">
