    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
        ...
        {ready && (
          <>
            {msg && (
              <div className={`mb-4 p-3 rounded-xl text-xs font-semibold ${msg.startsWith('Password updated successfully') ? 'bg-emerald-50 text-emerald-700 border border-emerald-100' : 'bg-red-50 text-red-600 border border-red-100'}`}>
                {msg}
              </div>
            )}
            {!msg.startsWith('Password updated successfully') && (
